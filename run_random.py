...
from modules.parking_allocation_random import parking_lot_allocation
...
def run_sumo(t, right_count, result):
   ...
   # Record the information of the speed-restricted vehicle
    ...
    while step < t:
        ...
        if step < 3600:
            ...
            if step == 0:
                ...
                parking_lot_allocation(parking_type_info,
                         parking_allocation_data['1_1_PARK'],
                         parking_allocation_data['1_1_PUDO'], parking_allocation_data['1_1_LUL'],
                         parking_allocation_data['1_2_PARK'],
                         parking_allocation_data['1_2_PUDO'], parking_allocation_data['1_2_LUL'],
                         parking_allocation_data['1_3_PARK'],
                         parking_allocation_data['1_3_PUDO'], parking_allocation_data['1_3_LUL'],
                         )
            ...
            if step == 3600:
                ...
                # assign parking spaces and change the color of parking spaces
                parking_lot_allocation(parking_type_info,
                         parking_allocation_data['2_1_PARK'],
                         parking_allocation_data['2_1_PUDO'], parking_allocation_data['2_1_LUL'],
                         parking_allocation_data['2_2_PARK'],
                         parking_allocation_data['2_2_PUDO'], parking_allocation_data['2_2_LUL'],
                         parking_allocation_data['2_3_PARK'],
                         parking_allocation_data['2_3_PUDO'], parking_allocation_data['2_3_LUL'],
                         )
            # the simulation starts, controlling the vehicle to park
            parking_wizard(step, veh_dict, link, parking_link, parking_area_list,
                           parking_list, parking_buffer, parking_type_info, parking_actual, veh_first_zone, result)
            ...
            if step == 7200:
                ...
                # assign parking spaces and change the color of parking spaces
                parking_lot_allocation(parking_type_info,
                         parking_allocation_data['3_1_PARK'],
                         parking_allocation_data['3_1_PUDO'], parking_allocation_data['3_1_LUL'],
                         parking_allocation_data['3_2_PARK'],
                         parking_allocation_data['3_2_PUDO'], parking_allocation_data['3_2_LUL'],
                         parking_allocation_data['3_3_PARK'],
                         parking_allocation_data['3_3_PUDO'], parking_allocation_data['3_3_LUL'],
                         )
            # the simulation starts, controlling the vehicle to park
            parking_wizard(step, veh_dict, link, parking_link, parking_area_list,
                           parking_list, parking_buffer, parking_type_info, parking_actual, veh_first_zone, result)
            ...
            if step == 10800:
                ...
                parking_type_info = {}
                parking_lot_allocation(parking_type_info,
                         parking_allocation_data['4_1_PARK'],
                         parking_allocation_data['4_1_PUDO'], parking_allocation_data['4_1_LUL'],
                         parking_allocation_data['4_2_PARK'],
                         parking_allocation_data['4_2_PUDO'], parking_allocation_data['4_2_LUL'],
                         parking_allocation_data['4_3_PARK'],
                         parking_allocation_data['4_3_PUDO'], parking_allocation_data['4_3_LUL'],
                         )
            parking_wizard(step, veh_dict, link, parking_link, parking_area_list,
                           parking_list, parking_buffer, parking_type_info, parking_actual, veh_first_zone, result)
        else:
            if step == 14400:
                ...
                parking_type_info = {}
                parking_lot_allocation(parking_type_info,
                         parking_allocation_data['5_1_PARK'],
                         parking_allocation_data['5_1_PUDO'], parking_allocation_data['5_1_LUL'],
                         parking_allocation_data['5_2_PARK'],
                         parking_allocation_data['5_2_PUDO'], parking_allocation_data['5_2_LUL'],
                         parking_allocation_data['5_3_PARK'],
                         parking_allocation_data['5_3_PUDO'], parking_allocation_data['5_3_LUL'],
                         )
    ...
    with open(f'output_random/output{right_count}.csv', 'w', newline='') as csvfile:
    ...
    with open(f'output_random/output_limit{right_count}.csv', 'w', newline='') as csvfile:
    ...
    with open(f'output_random/output_limited_road{right_count}.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
    ...
    with open(f'output_random/output_background{right_count}.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
...
if __name__ == '__main__':
     ...
     for i in range(3):
         ...
         try:
             ...
             with open('input/space_random_allocation.csv', newline='') as csvfile:
                 reader = csv.DictReader(csvfile)
                 for row in reader:
                     key = f"{row['time']}_{row['zone']}_{row['usage']}"
                     parking_allocation_data[key] = int(row['allocation_round'])
